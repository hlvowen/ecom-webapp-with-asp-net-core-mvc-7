...
{
    /// <inheritdoc />
    public partial class AddProductTableAndSeedDataToDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForMoreThan50 = table.Column<double>(type: "float", nullable: false),
                    PriceForMoreThan100 = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Author", "Description", "ISBN", "Price", "PriceForMoreThan100", "PriceForMoreThan50", "PriceList", "Title" },
                values: new object[,]
                {
